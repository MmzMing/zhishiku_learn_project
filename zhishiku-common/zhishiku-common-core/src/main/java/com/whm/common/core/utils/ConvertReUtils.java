...
public class ConvertReUtils {
    ...
    public static final Pattern replaceBlankPattern = Pattern.compile("\\s*|\t|\r|\n");
    ...
    public static String readStatic(String url) {
        ...
        try {
            ...
            InputStream stream = ConvertReUtils.class.getClassLoader().getResourceAsStream(url.replace("classpath:", ""));
