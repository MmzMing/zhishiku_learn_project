package com.whm.common.redis.util;
 ...
 *
 * @author : 吴华明
 * @since 2025-12-12  21:06
 */
public class RedisPropertiesHelper {
    ...
    public static List<RedisNode> createSentinels(RedisProperties.Sentinel sentinel) {
