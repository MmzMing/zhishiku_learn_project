...
public class ValidateCodeFilter extends AbstractGatewayFilterFactory<Object> {
    ...
    public GatewayFilter apply(Object config) {
        return (exchange, chain) -> {
            ...
            // 非登录/注册请求或验证码关闭，不处理
            if (!StringUtils.containsAnyIgnoreCase(request.getURI().getPath(), VALIDATE_URL) || !captchaConfigInfo.getEnabled()) {
            ...
            try {
                ...
                validateCodeService.checkCaptcha(obj.getString(Constants.CODE), obj.getString(Constants.UUID));
            } catch (Exception e) {
